...
export function registerCastTools(server) {
    // --- Tool: cast_call -------------------------------------
    server.registerTool("cast_call", {
        title: "Cast call",
    ...
    server.registerTool("cast_estimate_gas", {
    ...
    // --- Tool: cast_balance ----------------------------------
    server.registerTool("cast_balance", {
        title: "Cast balance",
    ...
    server.registerTool("cast_wallet_info", {
