...
export function registerForgeTools(server) {
    // --- Tool: forge_build -----------------------------------
    server.registerTool("forge_build", {
        title: "Forge build",
        description: "Run `forge build` in the current Foundry project to compile contracts.",
        inputSchema: {
            profile: z
                .string()
                .optional()
    ...
    // --- Tool: forge_test ------------------------------------
    server.registerTool("forge_test", {
        title: "Forge test",
        description: "Run `forge test` with optional filters and flags to execute Solidity tests.",
        inputSchema: {
            matchTest: z
                .string()
                .optional()
