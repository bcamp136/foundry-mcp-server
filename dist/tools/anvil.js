...
export function registerAnvilTools(server) {
    // --- Tool: anvil_start -----------------------------------
    server.registerTool("anvil_start", {
        title: "Start Anvil",
        description: "Start a local Anvil blockchain node with optional configuration.",
        inputSchema: {
            port: z
                .number()
                .optional()
    ...
    // --- Tool: anvil_stop ------------------------------------
    server.registerTool("anvil_stop", {
        title: "Stop Anvil",
    ...
    // --- Tool: anvil_status ----------------------------------
    server.registerTool("anvil_status", {
        title: "Anvil Status",
